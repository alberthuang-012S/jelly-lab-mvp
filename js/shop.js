import { ACCESSORIES, BATTLE_SHOP_ITEMS, FOODS, QUANTITY_CONFIG, SCENES, SKINS } from "./config.js?v=2.18.2";
import { addBattleItem, addFood, getEquippedAccessories, spendPoints } from "./state.js?v=2.18.2";
