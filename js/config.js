...
export const FOODS = [
  {
    ...
    shortName: "IEQ+1",
    icon: "🍍",
    visualType: "pineapple-green",
    visualAccent: "#245449",
    visualSecondary: "#8fb88a",
    visualText: "#fff7d9",
    visualMark: "✦",
    requiredLevel: 1,
    exp: 10,
    price: 20,
    description: "晶亮春茶與鳳梨酥的清新香氣，補充小水母的成長能量。"
  },
  {
    id: "food_cookie",
    type: "food",
    ...
    shortName: "IPS+1",
    icon: "🍍",
    visualType: "pineapple-yellow",
    visualAccent: "#f1c94f",
    visualSecondary: "#fff1a9",
    visualText: "#674b31",
    visualMark: "✿",
    requiredLevel: 1,
    exp: 25,
    price: 50,
    description: "酸甜莓果包裹著酥香鳳梨酥，讓心情亮晶晶。"
  },
  {
    id: "food_jelly",
    type: "food",
    name: "YSS+2 妖獸獸輕飄飄趙飛燕巧克力",
    shortName: "YSS+2",
    icon: "🍫",
    visualType: "chocolate-gold",
    visualAccent: "#d9a52b",
    visualSecondary: "#ffe77e",
    visualText: "#fff8dd",
    visualMark: "✦",
    requiredLevel: 1,
    exp: 50,
    price: 100,
    description: "金色包裝的輕盈巧克力，入口像在海面飄起來。"
  },
  {
    id: "food_cake",
    type: "food",
    name: "BBB+2 亮睛睛黃白千里眼巧克力",
    shortName: "BBB+2",
    icon: "🍫",
  ...
  },
  {
    ...
    shortName: "BF02+1",
    icon: "☀",
    visualType: "breakfast-orange",
    visualAccent: "#e88746",
    visualSecondary: "#ffc478",
    visualText: "#fff6e5",
    visualMark: "☀",
    requiredLevel: 1,
    exp: 150,
    price: 300,
    description: "橘色束口袋裡裝著一天的早餐能量。"
  }
];
