import { ACCESSORIES, BATTLE_SHOP_ITEMS, FOODS, QUANTITY_CONFIG, SCENES, SKINS } from "./config.js?v=2.17.0";
import { addBattleItem, addFood, getEquippedAccessories, spendPoints } from "./state.js?v=2.17.0";
